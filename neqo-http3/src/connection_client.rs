...
use crate::{Header, NewStreamType, ReceiveOutput, RecvMessageEvents, ResetType};
use neqo_common::{
...
impl Http3Client {
    ...
    fn handle_stream_readable(&mut self, stream_id: u64) -> Res<()> {
        ...
        {
            ReceiveOutput::NewStream(NewStreamType::Push) => self.handle_new_push_stream(stream_id),
