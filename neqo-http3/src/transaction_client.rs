...
use crate::response_stream::{PushInfo, ResponseStream};
use crate::Header;
...
impl TransactionClient {
    pub fn new(
        ...
        TransactionClient {
            ...
            response_stream: ResponseStream::new(stream_id, None, conn_events.clone()),
            stream_id,
            conn_events,
        }
    }
    ...
    pub fn new_push(
        ...
        qinfo!(
            "Create a push stream stream_id={} push_id={}",
            stream_id,
            push_id
        );
        TransactionClient {
            send_state: TransactionSendState::Closed,
            response_stream: ResponseStream::new(stream_id, Some(push_id), conn_events.clone()),
            stream_id,
            conn_events,
        }
    }
