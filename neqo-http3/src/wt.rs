...
use crate::{
    AppError, Error, Header, Http3StreamType, HttpRecvStream, HttpSendStream, ReceiveOutput,
    RecvMessageEvents, RecvStream, Res, ResetType, SendStream, WtEvents, WtRecvStream,
    WtSendStream,
};
...
pub enum WebTransportControllerState {
    Negoiating,
    Negotiated,
    NegotiationFailed,
}
...
impl WebTransportController {
    ...
    pub fn state(&self) -> WebTransportControllerState {
        self.state
    }
}
...
impl WebTransportHttpEventsListenerResult {
    ...
    fn result(&self) -> Option<bool> {
        match self {
            WebTransportHttpEventsListenerResult::Negoiating => None,
...
impl WebTransportSession {
    pub fn new(
        ...
        let listener = Rc::new(RefCell::new(
            WebTransportHttpEventsListenerResult::Negoiating,
        ));
        Self {
